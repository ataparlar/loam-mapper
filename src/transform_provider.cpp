...
{
TransformProvider::TransformProvider(const boost::filesystem::path & pose_txt)
{
...
TransformProvider::Pose TransformProvider::get_pose_at(uint32_t stamp_unix_seconds, uint32_t stamp_nanoseconds)
{
  Pose pose_search;
